...
trexes100-own [mycarcass mybone rex_energy  fitness flesh-gain bone-gain energy occupied?]  
trexes500-own [mycarcass mybone rex_energy  fitness flesh-gain bone-gain energy occupied?]  
trexes1000-own [mycarcass mybone rex_energy  fitness flesh-gain bone-gain energy occupied?]  
trexes2000-own [mycarcass mybone rex_energy  fitness flesh-gain bone-gain energy occupied?]
trexes3000-own [mycarcass mybone rex_energy  fitness flesh-gain bone-gain energy occupied?]
trexes4000-own [mycarcass mybone rex_energy  fitness flesh-gain bone-gain energy occupied?]
trexes5000-own [mycarcass mybone rex_energy  fitness flesh-gain bone-gain energy occupied?]
trexes6000-own [mycarcass mybone rex_energy  fitness flesh-gain bone-gain energy occupied?]
trexes7000-own [mycarcass mybone rex_energy  fitness flesh-gain bone-gain energy occupied?]
trexes8000-own [mycarcass mybone rex_energy  fitness flesh-gain bone-gain energy occupied?]
trexes9000-own [mycarcass mybone rex_energy  fitness flesh-gain bone-gain energy occupied?]
trexes10000-own [mycarcass mybone rex_energy  fitness flesh-gain bone-gain energy occupied?]
...
dromaeosaurs-own [mycarcass rap_energy flesh-gain-rap  occupied?]
troodons-own [mycarcass rap_energy flesh-gain-rap  occupied?]
albertosaurus-own [mycarcass rap_energy flesh-gain-rap  occupied?]
...
to go 
if ticks = 43200  [set day day + 1 create-next-day]  ;; equals 8 hours ;; changed from 43200
if day = 30 [stop] 
...
ask turtles with [color = white and breed = bones75] [set energy energy - 0.000248016]
ask turtles with [color = white and breed = bones216] [set energy energy - 0.000714286]
ask turtles with [color = white and breed = bones700] [set energy energy - 0.002314815]
ask turtles with [color = white and breed = bones2500] [set energy energy - 0.008267196]
ask turtles with [color = white and breed = bones5000] [set energy energy - 0.016534392]
ask turtles with [color = white and breed = bones8500] [set energy energy - 0.028108466]
ask turtles with [color = white and breed = bones25000] [set energy energy - 0.082671958]
...
;;----------------------------------------------------------------------------------------------------;;
 ...
 if ticks  = 0 [calculate-fitness]]     
  ...
  ask trexes100 [jump 0.00133 avoidTrex100 set rex_energy rex_energy - 0.65]
  ask trexes500 [jump 0.00171 avoidTrex500 set rex_energy rex_energy - 2.55]
  ask trexes1000 [jump 0.0019 avoidTrex1000 set rex_energy rex_energy - 4.63]
  ask trexes2000 [jump 0.00212 avoidTrex2000 set rex_energy rex_energy - 8.56]
  ask trexes4000 [jump 0.00236 avoidTrex4000 set rex_energy rex_energy - 15.51]
  ask trexes6000 [jump 0.00252 avoidTrex6000 set rex_energy rex_energy - 22.22]
  ask trexes8000 [jump 0.00263 avoidTrex8000 set rex_energy rex_energy - 28.94]
  ask trexes10000 [jump 0.00273            set rex_energy rex_energy - 34.72]                                             
;;----------------------------------
ask dromaeosaurs  
[jump 0.001
  if random-float 1 < ( 1 / 3600 )                                          
...
to forage_trex 
 if any? turtles with [shape = "circle" and occupied? = "no"] in-radius rex_vision ; and (flesh-gain + bone-gain) /  < 1  
    [ set mycarcass min-one-of turtles with [shape = "circle"]  in-radius rex_vision  
      [distance myself]   
      set heading towards mycarcass
   if distance mycarcass < 0.1  [fd 0 set flesh-gain flesh-gain + 15]; changed from 1
        ask mycarcass  [if any? turtles with [color = green] in-radius 0.101  [set energy energy - 15] ; changed from 1
          ]]
             set_bone
end

to set_bone
  if any? turtles with [shape = "star"] in-radius 0.1 ;and (flesh-gain + bone-gain) /  < 1 
    [ set mycarcass 0] 
    eat_bone
 end

to eat_bone
  if any? turtles with [shape = "star"] in-radius rex_vision ;and (flesh-gain + bone-gain) /  < 1 
    [ set mycarcass min-one-of turtles with [shape = "star"]  in-radius rex_vision  
      [distance myself]   
      set heading towards mycarcass
   if distance mycarcass < 0.1  [fd 0 set bone-gain bone-gain + 5] ;; changed from 1
        ask mycarcass  [if any? turtles with [color = green] in-radius 0.101  [set energy energy - 5]]]
end 
...
to forage_dromaeosaurs 
 if any? turtles with [shape = "circle" and color != white] in-radius rap_vision ;and flesh-gain-rap /  < 1 
...
if color != white and shape = "circle" and any? dromaeosaurs in-radius 0.101 ;with [flesh-gain-rap /  < 1] 
[set energy energy - 0.0032 * count dromaeosaurs-here] 
end
...
if color != white and shape = "circle" and any? troodons in-radius 0.101 ;with [flesh-gain-rap /  < 1] 
[set energy energy - 0.0032 * count troodons-here] 
end

to forage_albertosaurs 
 if any? turtles with [shape = "circle" and color != white] in-radius rex_vision ;and flesh-gain-rap /  < 1
...
if color != white and shape = "circle" and any? albertosaurus in-radius 0.101 ;with [flesh-gain-rap /  < 1] 
[set energy energy - 1 * count albertosaurus-here] ;; this value should change
...
to create-next-day
 ...
 ; ask turtles with [color = "green"] [set rex_energy (flesh-gain) + (bone-gain) 
  ...
  ask turtles with [color = green] [set energy rex_energy + (flesh-gain * 7000) + (bone-gain * 6700) 
  set flesh-gain 0 
  set bone-gain 0 ]
